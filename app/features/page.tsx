            ...
            return (
              <FadeUp key={feature.title} delay={0.1 + i * 0.08}>
                <SpotlightCard glowColor={feature.glowColor}>
                  <div className="w-12 h-12 rounded-xl bg-slate-900 border flex items-center justify-center relative shadow-lg group-hover:scale-105 transition-transform mb-6 overflow-hidden glow-icon-pod">
